...
class DOW:
    con=mysql.connector.connect(host="localhost",user="root",password="12345",database="dow")
    check=0
    def __init__(self,root):
        ...
        self.r=root
        self.r.title("Database on Wheels Login")
        self.r.geometry("500x500")
        s=ttk.Style(self.r)
        s.theme_use("clam")
        cur=self.con.cursor()
        t=Label(self.r,text="Welcome to Database on Wheels",font=('arial black',20),foreground='#191970').pack()
        user=Label(self.r,text="USERNAME",font=('arial',9),foreground='#191970').place(x=145,y=150)
        self.g=Entry(self.r,textvariable=self.a)
        self.g.place(x=220,y=150)
        passw=Label(self.r,text="PASSWORD",font=('arial',9),foreground='#191970').place(x=145,y=180)
        self.h=Entry(self.r,textvariable=self.b,show="*")
        self.h.place(x=220,y=180)
        self.bo=Button(self.r,text="Login as Admin",font=('arial',9),foreground='#191970',command=self.submit)
        self.bo.place(x=180,y=220)
        self.bo1=Button(self.r,text="Login as User",font=('arial',9),foreground='#191970',command=self.usubmit)
        self.bo1.place(x=290,y=220)
        self.bo2=Button(self.r,text="Sign Up",font=('arial',9),foreground='#191970',command=self.signup)
        self.bo2.place(x=270,y=260)
        self.con.commit()
    ...
    #creating the main window
        ...
        #displaying available cars
            ...
            tree.column("Rent",width=90,minwidth=90,anchor=CENTER)
            ...
            tree.heading("Rent",text="Rent(in $/day)",anchor=CENTER)
            ...
            b10=Button(frame2,text="REFRESH",font=('arial',9),foreground='#191970',command=self.enter).place(x=290,y=420)
